...
public class Kruskal {
	...
	public Graph getGraph(Graph g) {
		// множество Е ребер исходного графа
		Vector<Edge> edges = g.edges();

		// множество вершин исходного графа
		Vector<Vertex> vertexes = g.vertexes();

		// множество элементами которого явл. множества вершин,
		// соответствующих компонентам исходного графа
		Vector<Vector<Vertex>> vs = new Vector<>();

		// множество ребер остовного дерева
